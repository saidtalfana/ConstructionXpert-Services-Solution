            ...
            <div class="navbar">
                ...
                <div class="links">
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/AddTaskServlet?projectId=${projectId}">Add Task</a></li>
                    </ul>
            ...
            <div class="project-info">
                ...
                <div class="card">
                    ...
                    <div class="card_buttom">
                        <P id="p">${task.description} </p>

                        <div>



                            <a class="btn_all" href="${pageContext.request.contextPath}/UpdateTaskServlet?taskId=${task.taskId}&projectId=${projectId}" class="update-button">Update</a>
                            <a class="btn_edit" href="${pageContext.request.contextPath}/DeleteTaskServlet?taskId=${task.taskId}&projectId=${projectId}" class="delete-button">Delete</a>
                            <a class="btn_delete" href="${pageContext.request.contextPath}/ListResourcesServlet?taskId=${task.taskId}" class="resources-button">Resources</a>
